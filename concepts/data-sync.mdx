...
description: "Keep Kayko EBM data in sync with x-last-request-date incremental pulls for branches, items, imports, purchases, and stock."
keywords:
  - EBM data sync
  - x-last-request-date
  - incremental sync
