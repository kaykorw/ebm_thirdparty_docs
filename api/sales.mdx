---
title: Sales
description: Submit sales invoices to RRA and receive cryptographic receipt data for EBM-compliant printing.
icon: receipt
---


<Note>
  For a step-by-step guide with business rules, see the [Sales Invoice Workflow](/workflows/sales-invoice).
</Note>
...
curl -X POST "https://vsdc.kayko.rw/rra-2.1.2.3.8/trnsSales/saveSales" \
  ...
  -d '{
    ...
    "itemList": [{
      ...
      "taxTyCd": "B",
      "qty": 2, "prc": 1000, "splyAmt": 2000,
      "taxblAmt": 2000, "taxAmt": 305.08, "totAmt": 2000,
      "pkg": 1, "pkgUnitCd": "NT", "qtyUnitCd": "U",
...
const sale = await vsdcPost('/trnsSales/saveSales', {
  tin: '100027060', bhfId: '00',
  invcNo: '1799', orgInvcNo: '1799',
  cfmDt: '20260303145619', salesDt: '20260303',
  salesTyCd: 'N', rcptTyCd: 'S', pmtTyCd: '02',
  salesSttsCd: '02', prchrAcptcYn: 'Y',
  custNm: 'RULIBA CLAYS LTD', custTin: '100004527',
  totItemCnt: 1,
  taxRtB: 18, taxblAmtB: 2000, taxAmtB: 305.08,
  totTaxblAmt: 2000, totTaxAmt: 305.08, totAmt: 2000,
  receipt: {
    rptNo: '1799', custTin: '100004527',
    trdeNm: 'RULIBACLAYSLTD',
    topMsg: 'SONATUBES Ltd\nADDRESS KIGALI\nTIN 100027060',
    btmMsg: 'Kayko v.2.3.11', prchrAcptcYn: 'Y',
  },
  itemList: [{ /* line items */ }],
  regrId: '1', regrNm: 'Kayko',
  modrId: '1', modrNm: 'Kayko',
...
// Print these on the receipt:
console.log(sale.data.rcptSign, sale.data.intrlData);
```

```php PHP
<?php
$result = vsdcPost('/trnsSales/saveSales', $salePayload);
$signature = $result['data']['rcptSign'];
$internalData = $result['data']['intrlData'];
```
...
await vsdcPost('/trnsSales/resendSales', {
  ...originalSalePayload,
  receipt: {
...
```php PHP
<?php
vsdcPost('/trnsSales/resendSales', $resendPayload);
```
