...
Optional header totals (`taxable_amount_a`–`tt`, `tax_amount_*`, `total_*`), omit them to let Kayko compute from lines. If you send them, they must match. Kayko forwards live VSDC rates **`taxRtF: 18`** (VAT on fuel) and **`taxRtTt: 3`**.
