---
title: Purchases
description: Pull supplier invoices registered to your TIN and confirm them as purchases.
icon: cart-shopping
---
...
Confirm a purchase transaction. Map the supplier's items to your own `itemCd` before submitting.
...
ebmPost('/trnsPurchase/savePurchases', $confirmation);
```
...
- [Stock](/api/stock) — adjust inventory after confirming
- [Calculations — Stock & Purchases](/calculations/stock-and-purchases) — amount formulas
