...
Submit stock master **after** `saveStockItems` to keep VSDC inventory in sync with your ERP.
...
|----------|-----------|---------|
| `selectTrnsPurchaseSales` | Pull from RRA | Pre-calculated by supplier's VSDC |
...
- [Stock Workflow](/workflows/stock-management)- step-by-step guide
- [Purchases Workflow](/workflows/purchases)- purchase confirmation flow
