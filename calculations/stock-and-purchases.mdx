...
description: "Amount formulas for automatic stock movements, stock master updates, and purchase confirmations in Kayko EBM."
keywords:
  - EBM stock calculations
  - purchase amounts
  - stock master formula
icon: boxes-stacked
---
