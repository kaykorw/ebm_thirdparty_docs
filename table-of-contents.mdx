...
| [Sales](/api/sales) | Issue invoices, refunds, resends — with field reference |
| [Purchases](/api/purchases) | Pull and confirm supplier invoices |
| [Stock](/api/stock) | Stock in/out, master updates, and movement history |
