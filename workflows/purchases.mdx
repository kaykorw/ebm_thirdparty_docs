...
sequenceDiagram
    ...
    Buyer->>VSDC: POST /trnsPurchase/selectTrnsPurchaseSales
    VSDC-->>Buyer: Unconfirmed purchase invoices
    Buyer->>VSDC: POST /trnsPurchase/savePurchases
    VSDC->>RRA: Confirm purchase
    RRA-->>VSDC: Acknowledged
    VSDC-->>Buyer: resultCd: 000
```
...
```php PHP
<?php
$response = vsdcPost('/trnsPurchase/selectTrnsPurchaseSales', [
    'tin' => '999958074',
    'bhfId' => '00',
    'lastReqDt' => '20240706204443',
]);
